        ...
        for (const offer of this.freeItemOffers) {
            if (itemCounts[offer.item]) {
                ...
                while (canApply) {
                    ...
                    itemCounts[offer.item] = itemCounts[offer.item] ? Math.max(0, itemCounts[offer.item] - offer.count) : 0;

                    itemCounts[offer.freeItem] = Math.max(0, itemCounts[offer.freeItem] - 1);
